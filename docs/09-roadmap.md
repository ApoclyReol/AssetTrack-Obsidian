...
v1.0.0 已完成纯 TypeScript 架构和账单体验：
...
3. 处理 v1.0.0 本地验证反馈，保持 schema 9 和财务口径冻结。
4. 补充作者确认的 LICENSE，并完成 Community Plugin 安全与质量清单。
5. 使用同一 v1.0.0 三文件产物提交 Community Plugins。
