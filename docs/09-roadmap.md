...
v1.8.1 已完成需求实现和自动化发布门禁，真实 Obsidian smoke 仍按发布日志作为人工门禁。它在 v1.8.0 基础上补充多格式日期兼容和规则列表管理工具，继承纯 TypeScript 架构、个性化金额设置、双资产口径、周期消费
面板、自动中英文界面与规则工作台，并完成 Obsidian 1.13 兼容升级：

- TypeScript Service/Repository 和 `node:sqlite`；
- schema 11，包含 schema 9→10→11 保护备份迁移、理财流水账户、通用规则、代付独立规则类型、流水来源和操作日志；
- 标准三文件、跨 CPU 架构产物；
...
- 日期解析按行兼容短年份、中文、紧凑和 Excel 日期值；规则列表直接提供筛选、分组和排序。
