...
v1.5.0 已发布。它继承纯 TypeScript 架构、个性化金额设置、双资产口径、周期消费
...
- 保存警告可定位到具体区块和行号，优先处理未分类、规则冲突、对账差额和特殊交易遗漏。
- 规则中心继续承担跨月商品、分类和规则治理；规则不是每月必经流程。
...
- v1.5.0 维护阶段已完成第一轮职责拆分：分析页面、流水/固定资产表、规则工作台、
